class iOS {
  ...
  get hexButton() {
    return this.driver.$("accessibility id:HandledException");
  }

  get goodHTTRequestButton() {
    return this.driver.$("accessibility id:Good Http Request");
  }
  get badHTTPRequestButton() {
    return this.driver.$("accessibility id:Bad Http Request");
  }
  ...
  get delayedRequestButton() {
    return this.driver.$("accessibility id:Delayed Http Request");
  }
  ...
  async addTodo() {
    ...
    const typeH = await this.driver.$("accessibility id:H");
    await typeH.click();
    await this.driver.setTimeouts(3000);
    const typeE = await this.driver.$("accessibility id:e");
    await typeE.click();
    await this.driver.setTimeouts(3000);
    const typeL = await this.driver.$("accessibility id:l");
    await typeL.click();
    await this.driver.setTimeouts(3000);
    await typeL.click();
    await this.driver.setTimeouts(3000);
    const typeO = await this.driver.$("accessibility id:o");
    await typeO.click();
    await this.driver.setTimeouts(3000);
